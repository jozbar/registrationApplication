...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.intercept = function (request, next) {
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            var errors = err.error.errors || err.statusText;
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.userService.register(this.registerForm.value)
            ...
            debugger;
            _this.router.navigate(['/'], { queryParams: { registered: true, username: data.username } });
        }, function (error) {
            debugger;
            _this.errors = error;
            _this.loading = false;
...
module.exports = __webpack_require__(/*! C:\data\app-register\appregister-frontend\src\main.ts */"./src/main.ts");
